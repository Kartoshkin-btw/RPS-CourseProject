        ...
        <c:forEach var="combinations" items="${listCombinations}" varStatus="status">
            <div class="product">
                ...
                <div class="bot">
                    ...
                    <sec:authorize access="isAuthenticated()">
                        <form:form action="addCombinationToCart" method="post">
                            <input type="hidden" name="id" value="${combinations.id}"/>
                            <select name="size">
                            ...
                            <td colspan="2" align="center"><button type="submit">Выбрать</button></td>
                        </form:form>
                    </sec:authorize>
                    <sec:authorize access="hasRole('ROLE_ADMIN')">
