        ...
        <c:forEach var="template" items="${listTemplates}" varStatus="status">
            <tr>
                ...
                <td>
                    ...
                    <c:if test="${clothesID != null && imageID != null}">
                        <a class="choose" href="addCustomCombination?clothesID=${clothesID}&size=${size}&imageID=${imageID}&templateID=${template.id}">В корзину</a>
                    </c:if>
                </td>
                </sec:authorize>
            </tr>
